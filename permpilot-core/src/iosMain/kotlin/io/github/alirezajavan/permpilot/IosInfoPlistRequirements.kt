 ...
 */
internal fun Permission.Runtime.requiredInfoPlistKeys(): List<String> = when (this) {
    ...
    Permission.LocationAlways -> listOf(
    ...
    Permission.SendSms, Permission.ReadSms, Permission.ReceiveSms -> emptyList()
}
