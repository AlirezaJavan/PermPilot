 ...
 * together for it, gated to the exact API level each one was introduced at (see docs/permission-matrix.md).
...
internal fun Permission.Runtime.toManifestPermissions(): List<String> =
    when (this) {
 ...
 */
internal fun Permission.Runtime.requiredManifestDeclarations(): List<String> =
    when (this) {
...
internal fun resolveDeniedStateFrom(
